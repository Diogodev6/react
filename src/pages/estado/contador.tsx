        ...
        <Pagina titulo="Contador" subtitulo="Capítulo Estado">
            <div className="flex flex-col gap-5 justify-center items-center w-full h-full">
                ...
                <div className="flex gap-4">
                    <button onClick={decrementarDelta} className="bg-purple-500 rounded-full flex justify-center items-center w-9 h-9">
                        <IconMinus size={16}/>
                    </button>
                    <span>{delta}</span>
                    <button onClick={incrementarDelta} className="bg-purple-700 rounded-full flex justify-center items-center w-9 h-9">
                        <IconPlus size={16}/>
                    </button>
                </div>
